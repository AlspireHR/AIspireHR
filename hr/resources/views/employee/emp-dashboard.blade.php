...
@push('js')
    <!-- Place this script at the end of your body tag -->
     ...
     <script>
        var botmanWidget = {
            aboutText: 'HR Assistant',
            introMessage: "✋ Hi! I'm your HR assistant. How can I help you today?",
            title: 'HR Bot',
            mainColor: '#20c997',
            bubbleBackground: '#FFFFFF',
            placeholderText: 'Type your message here...',
            scrollOnRun: true,
            bubbleAvatarUrl: '{{ asset('assets/chaticon.png') }}',
            avatarUrl: '{{ asset('assets/chaticon.png') }}',
            mobileHeight: '100%',
            mobileWidth: '100%',
        };
    </script>
